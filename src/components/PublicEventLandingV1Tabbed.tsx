...
interface PublicEventLandingV1TabbedProps {
  event: any;
...
export function PublicEventLandingV1Tabbed({
  event,
  onEnterLiveEvent,
  onJoinLeapSpace,
  ShareMenu,
  ...
  faqs,
  chatMessages
}: PublicEventLandingV1TabbedProps) {
      ...
      <div className="h-full overflow-y-auto bg-muted">
          ...
          {activeLearnerTab === 'overview' && (
            <div className="max-w-4xl mx-auto p-6 space-y-6">
              {/* Hero Image */}
              <div className="w-full aspect-[2/1] bg-muted rounded-2xl"></div>
                  ...
                  {faqs.map((faq: any, i: number) => (
                    <Card key={i} className="shadow-none border-border">
                      ...
                      >
                        ...
                        {/* ChevronDown icon was missing in import, adding it or using a simple v */}
